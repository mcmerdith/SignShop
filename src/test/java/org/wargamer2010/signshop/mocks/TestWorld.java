...
public class TestWorld implements World {
    ...
    public TestWorld(String name, String uuid, List<Player> players, Map<Location, Block> blocks) {
        this(name, UUID.fromString(uuid), players, blocks);
    }

    public TestWorld(String name, UUID uuid, List<Player> players, Map<Location, Block> blocks) {
        this.name = name;
        this.uuid = uuid;
        if (players != null) this.players.addAll(players);
        if (players != null) this.blocks.putAll(blocks);

        TestServer.getServer().registerWorld(this);
    }

    public void registerBlock(Location location, Block block) {
